...
export function SiteFooter() {
  return <footer className="site-footer">
    <div className="site-footer-main">
      <div className="site-footer-intro"><Link className="brand" href="/"><span>Quantify Terminal</span><b>Newsroom</b></Link><p>Market-moving financial news connected to a professional research platform.</p></div>
      <nav aria-label="Newsroom links"><strong>Newsroom</strong><Link href="/">Top stories</Link><Link href="/latest">Latest news</Link></nav>
